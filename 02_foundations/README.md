...
This folder contains the ontological and geometric base of the model: emergence
of dimensions, relational radius, closure arithmetic, and the Mersenne spectrum.
...
- [`mersenne_spectrum.py`](mersenne_spectrum.py) - reproducible standard-library
  table for the Mersenne spectrum, innovation levels, and repeated-prime
...
- https://zenodo.org/records/18701688
- https://zenodo.org/records/18763083

Open gaps and interpretive steps should stay visible here rather than being
buried in later predictions.
